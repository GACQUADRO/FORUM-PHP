        ...
        <div class="col-xs6 col-md9">
          <div class="grix" id="grix">
            <div class="col-xs4 col-md8" id="grixTop">
              ...
              <div class="titre2">Modifier</div>
              <div class="titre4">Supprimer</div>
            </div>
            <div class="col-xs4 col-md8" id="grixforum" >
              <div class="grix xs1" id="Container">
                ...
                ?>
                <div href="article.php?id=<?= $question['id'];?>" id="PostsContent">
                  <div class="grix xs12 containe">
                    <div class="col-xs10 PostsContainer">
                      <div class="grix xs12 containes">
                        <a href="article.php?id=<?= $question['id'];?>" class="col-xs4 for"> 
                        <?= $question['titre']; ?> 
                        </a>
                        <a href="edit-question.php?id=<?= $question['id'] ?>" class="col-xs3 for2">Modifier</a>
                        <a href="actions/questions/deleteQuestionAction.php?id=<?= $question['id'] ?>" class="col-xs4 for3">Supprimer</a>
                      </div>
                    </div>
                  </div>
                </div>
