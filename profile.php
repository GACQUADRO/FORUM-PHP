                ...
                <div class="grix" id="grix">
                    ...
                    <div class="col-xs4 col-md8" id="grixforum">
                        <div class="grix xs1" id="Container">
                            ...
                            ?>
                            <div class="topcon">
                                <img src="https://www.w3schools.com/howto/img_avatar2.png" height="200px" width="200px" class="img">
                                <div class="groupeinfo">
                                    <div class="change">
                                        <p>@<?= $user_pseudo; ?></p>
                                    </div>
                                    <div class="groupeinfo2">
                            ...
                            ?>
                            <a class="descri"  href="article.php?id=<?= $question['id']; ?>" style="border:2px #0B4F6C solid">
                                    <?= $question['titre'] ?> |
...
<footer class="footer primary">
    <marquee>
        ...
        ses contacts sociaux (6 maximum), Eviter de se toucher le visage, Aérer les pièces le plus souvent possible, au minimum quelques minutes toutes les heures, Saluer sans serrer la main
        et arrêter les embrassades, Utiliser les outils numériques (TousAntiCovid). Pour plus d'informations retrouver nous sur le site internet ou appeler au numero suivants: https://www.gouvernement.fr/info-coronavirus / 0 800 130 000 (appel gratuit)
    </marquee>
</footer>
...
body::-webkit-scrollbar-thumb {
background: linear-gradient(transparent,#683ee8, #5729E5);
}
...
position: absolute;
width: 100%;
background-color: #683ee8 !important;
}
.grixfilter{
position: relative;
}
